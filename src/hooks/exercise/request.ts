...
export const getExerciseDetailRequest = async (
  ...
  try {
    const { data } = await api.get(
      `/dashboard-student/exercise/exercise_detail/${uuid}/`,
    );
...
//   try {
//     console.log(exercise_submission_uuid, test_type_id);
//     const { data } = await api.get(
//       `/dashboard-student/exercise/exercise_review/${exercise_submission_uuid}/${test_type_id}`,
//     );
...
//       "/dashboard-student/exercise/exercise_submission",
//       payload,
//     );
//     return data;
//   } catch (error) {
