...
import { TAfterTestProps } from "@/types/exercise";
...
const AfterTest = ({ props }: AfterTestProps) => {
  const exerciseTitle = decodeURIComponent(props.exercise_title);
