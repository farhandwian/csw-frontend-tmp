  ...
  return (
    <>
      <div className="relative px-3">
        ...
        <div
          className={` absolute right-1 top-2 flex h-[50px] w-[100%] max-w-[150px] items-center justify-center rounded-md p-1 ${quiz.status_pengerjaan === "belum-dikerjakan" ? "bg-[#fbe360]" : "bg-[#F48891]"}`}
        >
          <h4
