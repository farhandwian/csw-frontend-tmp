...
import { TReviewJawabanParams } from "@/types/uji-kemampuan";
...
const Page = ({ params }: { params: TReviewJawabanParams }) => {
  ...
  const prevButtonText = "list posttest";
  const prevButtonURL = `/student/uji-kemampuan/posttest/${params.module_id}/daftar-posttest/${params.sub_module_uuid}`;
  const finishButtonURL = `/student/uji-kemampuan/posttest/${params.module_id}/daftar-posttest/${params.sub_module_uuid}/deskripsi-posttest/${params.quiz_uuid}`;
