...
const LoginPage = () => {
  return (
    <MainLayout>
      <div className="flex sm:flex-row flex-col justify-center min-h-screen bg-white">
        <div className="flex sm:w-1/2 min-h-full flex-col px-6 lg:px-8">
        ...
        <div className="hidden sm:block w-1/2 flex-grow h-full">
          <img
